pipeline {
    ...
    post {
        ...
        unsuccessful {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER has failed', to: 'gabriel.avila@siriussoftware.com.br'
        }
         fixed {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build is fine!!!', to: 'gabriel.avila@siriussoftware.com.br'
        }
    }
}       